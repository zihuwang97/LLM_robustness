...
from src.distilation_module import data_module_distilation, distilation_module
...
class lightning_module_distilation:
    def __init__(
        self,
        opt,
        do_validation=True,
    ...
    def _get_data_module(self,
        ...
        if task_name.startswith("nli"):
            return data_module_distilation(
                data_name,
                tokenizer,
                tokenizer_kw,
                batch_size,
